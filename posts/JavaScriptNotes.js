...
// here the Square only take one property, but by using super, it assigns it to the two properties a Rectangle takes.  Rectangle(h,w)  >> Square = Rectangle(side,side) >> Square(side)
